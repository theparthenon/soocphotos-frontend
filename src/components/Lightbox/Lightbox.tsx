...
import Lightbox from "librephotos-react-image-lightbox";
import "librephotos-react-image-lightbox/style.css";
...
export function LightBox(props: Props) {
  ...
  return (
    <div>
      ...
      />
      {lightboxSidebarShow ? (
        <Sidebar photoDetail={getCurrentPhotodetail()} closeSidepanel={closeSidepanel} />
      ) : (
        <div />
      )}
    </div>
