  ...
  reducers: {
    ...
    updateRules: (state, action: PayloadAction<Partial<IUser>>) => ({
      ...
      userSelfDetails: UserSchema.parse({
        ...state.userSelfDetails,
        favorite_min_rating:
          action.payload.favorite_min_rating ?? state.userSelfDetails.favorite_min_rating,
        save_metadata_to_disk:
          action.payload.save_metadata_to_disk ?? state.userSelfDetails.save_metadata_to_disk,
      }),
    }),
  },
